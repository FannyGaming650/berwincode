...
old = 'const berwinVersion = "1.5.5"'
assert s.count(old) == 1
s = s.replace(old, 'const berwinVersion = "1.5.6"')
for p2, pairs in [
    ("C:\\Users\\Berwin Maniquiz\\BerwinCode\\BerwinCode.iss", [('"1.5.5"', '"1.5.6"')]),
    ("C:\\Users\\Berwin Maniquiz\\BerwinCode\\README.md", [("1.5.5", "1.5.6")]),
]:
