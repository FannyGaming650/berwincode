...
old = 'const berwinVersion = "1.5.8"'
assert s.count(old) == 1
s = s.replace(old, 'const berwinVersion = "1.5.9"')
for p3, pairs in [
    ("C:\\Users\\Berwin Maniquiz\\BerwinCode\\BerwinCode.iss", [('"1.5.8"', '"1.5.9"')]),
    ("C:\\Users\\Berwin Maniquiz\\BerwinCode\\README.md", [("1.5.8", "1.5.9")]),
]:
